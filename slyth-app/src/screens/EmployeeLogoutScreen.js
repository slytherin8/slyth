...
export default function EmployeeLogoutScreen({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.profileSection}>
                ...
                <Text style={styles.profileName}>{profile?.profile?.name || "User Name"}</Text>
                <Text style={styles.profileRole}>{profile?.profile?.jobRole || (profile?.role === 'admin' ? 'Admin' : 'Employee')}</Text>
            </View>
